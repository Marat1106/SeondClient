...
namespace Chat_Project {
  public static partial class ChatService
  {
    ...
    static readonly grpc::Marshaller<global::Chat_Project.Message> __Marshaller_Message = grpc::Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, global::Chat_Project.Message.Parser));
    ...
    public partial class ChatServiceClient : grpc::ClientBase<ChatServiceClient>
    {
      ...
      public virtual grpc::AsyncDuplexStreamingCall<global::Chat_Project.Message, global::Chat_Project.Message> Join(grpc::Metadata headers = null, global::System.DateTime? deadline = null, global::System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
      {
        return Join(new grpc::CallOptions(headers, deadline, cancellationToken));
      }
      public virtual grpc::AsyncDuplexStreamingCall<global::Chat_Project.Message, global::Chat_Project.Message> Join(grpc::CallOptions options)
      {
